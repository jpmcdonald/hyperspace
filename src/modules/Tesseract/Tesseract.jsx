...
import { tesseractPuzzles } from './puzzles.js';
...
export default function Tesseract() {
  ...
  // We mirror angles into React state only for the slider UI re-render.
  // The render loop reads directly from stateRef for performance.
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          Tesseract · 4-Cube · 16 vertices in 4D
        </div>
        {score.attempted > 0 && (
          <div style={{
        ...
        <div style={{
          ...
          click a corner to mark it · warm colors = farther in 4D · cool = closer
        </div>
      </div>
      ...
      {panelOpen && (
        <div style={{
          ...
          <div style={sectionLabel}>Cubic cells (8 total)</div>
          ...
          <div style={{
            ...
            3D has 3 rotation axes. 4D has 6 rotation <em>planes</em>. The yellow ones (XW, YW, ZW)
            move things through the 4th dimension — you'll see the shape appear to turn inside out.
          </div>
        </div>
      )}
    </div>
